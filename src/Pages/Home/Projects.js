...
const Projects = () => {
    return (
        <div className=''>
            <h1 class="lg:text-3xl font-bold drop-shadow lg:mt-12 text-primary">MY ALL PROJECTS</h1>
            ...
            <div className='grid px-6 lg:px-24 grid-col-4 lg:grid-cols-3 gap-3 m-3 justify-center  mt-5 mb-5 flex justify-center'>
                <div class="card bordered rounded w-96 bg-base-100 shadow-xl">
                    <figure><img className='h-56 w-96' src={p3} alt="Shoes" /></figure>
                    <div class="card-body">
                        <h2 class="font-bold text-lg  drop-shadow ">
                        ...
                        <div class=" flex  justify-center">
                            <button className='btn text-white btn-primary btn-sm rounded px-6 mt-2 ' >
                                <a href="https://computerhubmainu.netlify.app/portfolio" target='_blank'>Live Link</a> </button>

                            <button className='btn text-white btn-primary btn-sm rounded px-6 mt-2 ml-2 ' >
                                <a href="https://github.com/MAYINUDDIN/computer-hub-client" target='_blank'>  Client</a></button>

                            <button className='btn text-white btn-primary btn-sm rounded px-6 mt-2 ml-2 ' >
                                <a href="https://github.com/MAYINUDDIN/computer-hub-server" target='_blank'> Server</a></button>
                ...
                <div class="card bordered rounded w-96 bg-base-100 shadow-xl">
                    <figure><img className='h-56 w-96' src={p4} alt="Shoes" /></figure>
                    <div class="card-body">
                        <h2 class="font-bold text-lg  drop-shadow ">
                            Laptop Bazar
                        </h2>
                        ...
                        <div class=" flex  justify-center">
                            <button className='btn text-white btn-primary btn-sm rounded px-6 mt-2 ' >
                                <a href="https://laptop-bazar-mayin.netlify.app/" target='_blank'>Live Link</a> </button>

                            <button className='btn text-white btn-primary btn-sm rounded px-6 mt-2 ml-3 ' >
                                <a href="#" target='_blank'> Github Link</a></button>
